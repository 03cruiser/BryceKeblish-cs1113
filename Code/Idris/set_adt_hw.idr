...
-- the specifid "emptySet" abstraction, representing the empty set
-- with an empty list.
emptySet = mkSet nil
...
list_witness (h::t) p = ite (p h) (some h)
                                  (list_witness t p)

set_witness p (mkSet l) = (list_witness l p)
...
twolist: list a -> list b -> list (pair a b)
twolist nil l1 = nil
twolist (h::t) l2 = (one_element h l2) ++ (twolist t l2)

set_product (mkSet la) (mkSet lb) = mkSet (twolist la lb)
